...
import { LinkWithChannel } from "@/ui/common/LinkWithChannel";
...
export default async function Page({
  ...
  const checkoutId = await Checkout.getIdFromCookies((await params).channel);
        ...
        <div className="mt-12">
          <div className="rounded border bg-neutral-50 px-4 py-2">
            <div className="flex items-center justify-between gap-2 py-2">
              <div>
                <p className="font-semibold text-neutral-900">Total Price</p>
              </div>
